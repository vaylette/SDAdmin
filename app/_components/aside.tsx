        ...
        <>
            <aside className="min-h-screen lg:w-[354px] 2xl:w-[404px] bg-orange-default flex flex-col items-center px-4">
                ...
                <ul className="flex flex-col pt-14 gap-3 text-lg text-white-default">
                    ...
                    {(accessControl?.isSuperAdmin() || accessControl?.isContentAdmin()) && (

                        <li>
                            <Link href='/dashboard/user-management' className={`w-auto h-auto py-[22px] px-4 2xl:px-8 flex flex-row items-center gap-4 cursor-pointer radial rounded-lg ${pathname.startsWith('/dashboard/user-management') && 'radial_active'}`}>
                    ...
                    {(accessControl?.isSuperAdmin() || accessControl?.isContentAdmin() || accessControl?.isContentModerator()) &&
                        <li>
                            <Link href='/dashboard/content-management' className={`w-auto h-auto py-[22px] px-4 2xl:px-8 flex flex-row items-center gap-4 cursor-pointer radial rounded-lg ${pathname.startsWith('/dashboard/content-management') && 'radial_active'}`}>
                    ...
                    {accessControl?.isSuperAdmin() &&
                        <li>
                            <Link href='/dashboard/revenue' className={`w-auto h-auto py-[22px] px-4 2xl:px-8 flex flex-row items-center gap-4 cursor-pointer radial rounded-lg ${pathname.startsWith('/dashboard/revenue') && 'radial_active'}`}>
                    ...
                    {accessControl?.isSuperAdmin() &&
                        <li>
                            <Link href='/dashboard/reports' className={`w-auto h-auto py-[22px] px-4 2xl:px-8 flex flex-row items-center gap-4 cursor-pointer radial rounded-lg ${pathname.startsWith('/dashboard/reports') && 'radial_active'}`}>
                    ...
                    {(accessControl?.isSuperAdmin() || accessControl?.isCustomerCare()) &&
                        <li>
                            <Link href='/dashboard/tickets' className={`w-auto h-auto py-[22px] px-4 2xl:px-8 flex flex-row items-center gap-4 cursor-pointer radial rounded-lg ${pathname.startsWith('/dashboard/tickets') && 'radial_active'}`}>
                    ...
                    {(accessControl?.isSuperAdmin() || accessControl?.isCustomerCare()) &&
                        <li>
                            <Link href='/dashboard/announcements' className={`w-auto h-auto py-[22px] px-4 2xl:px-8 flex flex-row items-center gap-4 cursor-pointer radial rounded-lg ${pathname.startsWith('/dashboard/announcement') && 'radial_active'}`}>
