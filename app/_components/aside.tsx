...
export default function Aside() {
  ...
  return (
    <>
      <aside className="h-full lg:w-[454px] 2xl:w-[404px] bg-orange-default flex flex-col items-center">
        ...
        <ul className="flex flex-col pt-14 gap-3 text-lg text-white-default">
            ...
            <li>
                <Link href='/dashboard/user-management' className={`w-auto h-auto py-[22px] px-8 flex flex-row items-center gap-[22px] cursor-pointer radial rounded-lg ${pathname === '/dashboard/user-management' && 'radial_active mb-2'}`}>
            ...
            <li>
                <Link href='/dashboard/content-management' className={`w-auto h-auto py-[22px] px-8 flex flex-row items-center gap-[22px] cursor-pointer radial rounded-lg ${pathname === '/dashboard/content-management' && 'radial_active mb-2'}`}>
