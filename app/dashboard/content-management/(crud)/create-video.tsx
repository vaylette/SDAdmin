...
export default function CreateVideo({ subjects, onRefresh }: CreateVideoProps) {
            ...
            <form onSubmit={() => { }} className='flex flex-col gap-8 text-lg text-black-400 pb-[92px]' encType='multipart/form-data'>
                ...
                <div className='flex flex-col gap-2'>
                    <div className="flex items-center">
                        <label htmlFor="fileType">Video type</label>
                ...
                <div className='flex flex-col gap-2'>
                    <FileUpload allowedFileTypes={[".mp4"]} label={"Upload Video"} onFileSelected={(file) => {
